...
import com.cuneyt.garage64.adapter.ListRvAdapter;
...
import com.cuneyt.garage64.databinding.ActivityListBinding;
import com.cuneyt.garage64.entities.DiecastModel;
...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view= listBinding.constListMain;
        setContentView(view);
        ...
        try {
            ...
            listBinding.textCurrentUser.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Collections.sort(diecastLists, new Comparator<DiecastModel>() { //RecyclerView A->Z sıralama
                            ...
                            public int compare(DiecastModel diecastModel, DiecastModel t1) {
                                return t1.getSort().compareToIgnoreCase(diecastModel.getSort());
                            }
                        });
                    ...
                    referenceDiecast.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (lenghtBrand == 1) {
                                ...
                                diecastModel = new DiecastModel(uniqueId, trademark, car, model, tradeCode, sortString, photo);
    ...
    public void rvItemCount() { // RecyclerView'deki elemanları saymak için yapılan işlemler.
        ...
        referenceDiecast.child(currentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    int countDiecast = (int) snapshot.getChildrenCount(); // Sayma işlemi yaptırıldı.
                    listBinding.textTotalCar.setText(String.valueOf(countDiecast));
    ...
    /*public void rvItemCount() { // RecyclerView'deki elemanları saymak için yapılan işlemler.
        ...
        referenceDiecast = FirebaseDatabase.getInstance().getReference("Car").child("carBrand");
        referenceDiecast.child(currentUserId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                for (DiecastModel diecast : diecastLists) {
                    ...
                    if (diecast.getCarBrand().toLowerCase().contains(s.toLowerCase()) ||
                            ...
                            diecast.getTrademarkCode().toLowerCase().contains(s.toLowerCase()) ||
                            diecast.getTrademark().toLowerCase().contains(s.toLowerCase())) { // Araç markasına göre arama yaptırıldı.
    ...
    private void internetCheck() {
        ...
        if (networkInfo != null && networkInfo.isConnectedOrConnecting()) {
            ...
            AlertDialog.Builder builderClose = new AlertDialog.Builder(ListActivity.this);
